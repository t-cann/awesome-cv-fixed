...
%---------------------------------------------------------
  \cventry
    {Core Member \& Social Sailing Captain in 2014 \& Bosun in 2014} % Affiliation/role
    {Lancaster University Sailing Club} % Organization/group
    {Lancaster} % Location
    {Nov. 2014 - July.2018} % Date(s)
    {
...
%---------------------------------------------------------
  \cventry
    ...
    {Northwich Fencing Club} % Organization/group
    {Northwich, England} % Location
